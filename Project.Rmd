...
The Summary of the data indicates coloumns with more than 90% of the data missing from some coloumns. On closer examination of these coloumns and data indicates these are maximum, minimum, standard deviation, etc for each num_window. This data is also incomplete. 

As more than 90% percent of the data is missing, these colloumns are dropped. These data can easil be recreated from the other coloumns of the data. 
```{r}
#Removing coloumns with NAs and black spaces, these are coloumns which are mean, max, var etc. 
# these are coloumns that can be recreated from the Data3 
Data[Data==" "] <- NA
